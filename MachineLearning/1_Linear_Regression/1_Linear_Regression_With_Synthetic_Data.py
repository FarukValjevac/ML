...
# @title Define the functions that build and train an empty model
...
# Trains the model from the examples (feature and label) you pass.
...
print("\nThe trained weight for your model is %.4f" % trained_weight)
print("The trained bias for your model is %.4f\n" % trained_bias)
